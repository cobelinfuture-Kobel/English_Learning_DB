...
TASK_ID="A1FS-V1-U04R360-B08_Reader360E211E240CumulativeAcceptance"
STATUS="PASS_A1FS_V1_U04R360_B08_E211_E240_CUMULATIVE_E004_E240"
...
EXPECTED_IDS=tuple(f"U04-NEB-E{i:03d}" for i in range(4,241));LATEST_BATCH_IDS=tuple(f"U04-NEB-E{i:03d}" for i in range(211,241));EXPECTED_FAMILIES=tuple("ABCDEFG")
