...
TASK_ID="A1FS-V1-U04R360-B07_Reader360E181E210CumulativeAcceptance"
STATUS="PASS_A1FS_V1_U04R360_B07_E181_E210_CUMULATIVE_E004_E210"
...
EXPECTED_IDS=tuple(f"U04-NEB-E{i:03d}" for i in range(4,211));LATEST_BATCH_IDS=tuple(f"U04-NEB-E{i:03d}" for i in range(181,211));EXPECTED_FAMILIES=tuple("ABCDEFG")
