...
TASK_ID="A1FS-V1-U04R360-B09_Reader360E241E270CumulativeAcceptance"
STATUS="PASS_A1FS_V1_U04R360_B09_E241_E270_CUMULATIVE_E004_E270"
...
EXPECTED_IDS=tuple(f"U04-NEB-E{i:03d}" for i in range(4,271));LATEST_BATCH_IDS=tuple(f"U04-NEB-E{i:03d}" for i in range(241,271));EXPECTED_FAMILIES=tuple("ABCDEFG")
