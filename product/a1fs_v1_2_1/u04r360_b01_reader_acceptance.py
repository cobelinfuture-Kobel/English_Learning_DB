...
TASK_ID="A1FS-V1-U04R360-B06_Reader360E151E180CumulativeAcceptance"
STATUS="PASS_A1FS_V1_U04R360_B06_E151_E180_CUMULATIVE_E004_E180"
...
EXPECTED_IDS=tuple(f"U04-NEB-E{i:03d}" for i in range(4,181));LATEST_BATCH_IDS=tuple(f"U04-NEB-E{i:03d}" for i in range(151,181));EXPECTED_FAMILIES=tuple("ABCDEFG")
